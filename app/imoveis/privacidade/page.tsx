...
export const metadata: Metadata = {
  ...
  description: 'Como os dados são tratados na experiência pública do EME Imóveis.',
}
    ...
    <PageShell>
      <section className="mx-auto w-full max-w-3xl px-5 py-16 md:px-8 md:py-24">
        ...
        <p className="mt-5 text-pretty text-base leading-relaxed text-muted-foreground">
          Os interesses enviados pelos formulários são registrados no EME e vinculados ao corretor responsável e, quando aplicável, ao imóvel selecionado.
        </p>
        <div className="mt-10 rounded-3xl border border-border bg-surface p-6 md:p-8">
          ...
          <div className="mt-4 flex flex-col gap-4 text-sm leading-relaxed text-muted-foreground">
            <p>Dados como nome, telefone e preferências são utilizados para responder à solicitação do cliente e conectar o atendimento ao corretor responsável.</p>
            <p>O tratamento deve seguir a legislação aplicável, com controles de acesso e canais para consulta, correção ou exclusão das informações.</p>
