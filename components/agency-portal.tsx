        ...
        <div className="grid gap-6">
          <Card className="rounded-[1.75rem] border-white/[0.08] bg-[linear-gradient(180deg,rgba(17,17,17,0.96),rgba(14,14,14,0.92))] py-0 shadow-[0_18px_40px_rgba(0,0,0,0.18)]">
            ...
            <CardContent className="grid gap-3 p-5 pt-0">
              ...
              <div className="rounded-[1.25rem] border border-white/[0.08] bg-white/[0.03] p-4"><p className="text-sm text-white/50">Resumo</p><p className="mt-2 text-base font-semibold text-white">Conta ativa</p></div>
            </CardContent>
          </Card>
        </div>
      </section>
