...
const menuItems = [
  { label: "Dashboard", icon: LayoutDashboard, href: "/imobiliaria" },
  { label: "Corretores", icon: Users, href: "/imobiliaria/corretores" },
  { label: "Imóveis", icon: Building2, href: "/imobiliaria/imoveis" },
  { label: "Catálogo", icon: BookOpenText, href: "/imobiliaria/catalogo" },
  { label: "Analytics", icon: BarChart3, href: "/imobiliaria/analytics" },
  { label: "Plano", icon: CreditCard, href: "/imobiliaria/plano" },
  { label: "Suporte", icon: LifeBuoy, href: "/imobiliaria/suporte" },
  { label: "Conta", icon: UserRound, href: "/imobiliaria/conta" },
]
...
export function AgencySidebar() {
  ...
  async function handleLogout() {
    if (typeof window !== "undefined") {
      window.localStorage.removeItem("eme-agency-profile")
      window.localStorage.removeItem("eme-agency-catalog-settings")
      window.localStorage.removeItem("eme-agency-brokers")
      window.localStorage.removeItem("eme-agency-properties")
    }
      ...
      <Sheet open={openMobile} onOpenChange={setOpenMobile}>
        ...
        >
          <SheetHeader className="sr-only">
            <SheetTitle>Portal da imobiliária</SheetTitle>
            <SheetDescription>Navegação lateral do portal da imobiliária.</SheetDescription>
          </SheetHeader>
          {sidebarInner}
        </SheetContent>
      </Sheet>
