...
import { ArrowUpRight, Building2, ChartColumn, CircleDollarSign, Home, MapPin, Percent } from "lucide-react"
      ...
      {totalProperties === 0 && !isLoading ? (
        <section className="rounded-[1.75rem] border border-white/[0.08] bg-[linear-gradient(180deg,rgba(17,17,17,0.96),rgba(14,14,14,0.92))] p-8 text-center shadow-[0_18px_40px_rgba(0,0,0,0.18)]">
          ...
          <p className="mx-auto mt-3 max-w-xl text-sm leading-7 text-white/55">
            Cadastre seus imóveis para acompanhar valor de carteira, comissão potencial e indicadores comerciais sem dados artificiais.
          </p>
        ...
        <div className="grid gap-6">
          ...
          <section className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_360px]">
            ...
            <Card className="rounded-[1.75rem] border-white/[0.08] bg-[linear-gradient(180deg,rgba(17,17,17,0.96),rgba(14,14,14,0.92))] py-0 shadow-[0_18px_40px_rgba(0,0,0,0.18)]">
              <CardHeader className="px-6 py-5">
                <CardTitle className="text-xl text-white">Base usada</CardTitle>
              </CardHeader>
          ...
          <Card className="rounded-[1.75rem] border-white/[0.08] bg-white/[0.03] py-0">
            <CardContent className="p-5">
              <p className="text-sm leading-6 text-white/55">
                Finalidade venda/aluguel não está disponível nos dados atuais do catálogo, por isso não foi usada nos indicadores.
              </p>
            </CardContent>
          </Card>
        </div>
