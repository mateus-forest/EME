...
export function BrokerPortal() {
  ...
  return (
    <>
      ...
      >
        <section className="mx-auto flex min-h-[calc(100vh-10rem)] w-full max-w-6xl flex-col px-1 py-5 sm:px-3 lg:py-10">
          <div className="mx-auto w-full max-w-4xl text-center">
            ...
            <h2 className="mt-7 text-3xl font-semibold tracking-tight text-[#050505] sm:text-5xl">
              Olá, {brokerFirstName}.
            </h2>
            <p className="mt-3 text-lg text-[#667085] sm:text-xl">O que deseja fazer hoje?</p>
          </div>

          <div className="mx-auto mt-8 flex w-full max-w-4xl flex-wrap justify-center gap-2.5">
          ...
          <div className="mx-auto mt-11 w-full max-w-5xl">
            ...
            <div className="mt-5 grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
              {stats.map((stat) => (
                <div key={stat.title} className="rounded-2xl border border-black/[0.06] bg-white px-4 py-4 shadow-[0_12px_34px_rgba(15,23,42,0.04)]">
          ...
          <div className="mx-auto mt-8 grid w-full max-w-5xl gap-4 lg:grid-cols-[minmax(0,1.2fr)_minmax(280px,0.8fr)]">
            <div className="rounded-[1.75rem] border border-black/[0.06] bg-white px-5 py-5 shadow-[0_12px_34px_rgba(15,23,42,0.04)]">
