...
const authRelationSelect = {
  broker: {
    select: {
      ...
      creciValidatedAt: true,
      creciOfficialName: true,
      creciProviderStatus: true,
      creciValidationProvider: true,
      creciNameMismatch: true,
      description: true,
      catalogBannerUrl: true,
      catalogHeadline: true,
      catalogBio: true,
      catalogExperienceYears: true,
      catalogSoldProperties: true,
      catalogServiceArea: true,
      catalogCities: true,
      catalogPriceRange: true,
      catalogSpecialties: true,
      catalogDifferentials: true,
      catalogVideoUrl: true,
      catalogSlug: true,
      brandColor: true,
      logoUrl: true,
