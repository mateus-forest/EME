  ...
  capabilities: [
    ...
    },
    {
      descriptor: {
        ...
        description: "Atualiza data, horario, titulo ou observacoes de um compromisso.",
        domain: "agenda",
        entity: "agenda",
    ...
    },
    {
      descriptor: {
        ...
        description: "Cancela um compromisso da agenda mantendo o historico.",
        domain: "agenda",
        entity: "agenda",
    ...
    },
    {
      descriptor: {
        ...
        description: "Lista os compromissos planejados para os proximos sete dias.",
        domain: "agenda",
        entity: "agenda",
    ...
    },
    {
      descriptor: {
        ...
        title: "Agenda do mes",
        description: "Lista os compromissos do mes atual com panorama operacional.",
        domain: "agenda",
        entity: "agenda",
