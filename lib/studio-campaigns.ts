  ...
  return {
    ...
    property: campaign.property
        ? {
          ...
          description: campaign.property.description,
          price: campaign.property.price,
          bedrooms: campaign.property.bedrooms,
          bathrooms: campaign.property.bathrooms,
          parkingSpots: campaign.property.parkingSpots,
          type: campaign.property.type,
          purpose: campaign.property.purpose,
          status: campaign.property.status,
          legalData: campaign.property.legalData,
