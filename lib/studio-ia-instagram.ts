...
export function buildInstagramPrompt(input: StudioInstagramRequest, property: StudioInstagramPropertyContext) {
  return [
    ...
    "Pense em uma composicao visual premium, minimalista, com muita legibilidade e pouco texto.",
    ...
    "Para o post feed, entregue titulo e apoio com estrutura enxuta, adequada para destaque sobre a imagem do imovel.",
    "Para o story, entregue leitura ainda mais rapida, com titulo grande e poucos elementos textuais.",
